...
本仓库 `perf_takehome.py` 的 SHA-256 为 `0C19811CC864067A1F402EB1E5A2C072F79CE822DABECDDF3B819E2ABD526051`。它只使用 Python 标准库和原挑战的 `problem.py`，运行时不依赖额外的搜索工具或外部文件。
